...
import { useOptimisticProductPriceHistories } from "@/app/(app)/product-price-history/useOptimisticProductPriceHistories";
  ...
  return (
    ...
    >
      ...
      <Button variant={"link"} asChild>
        <Link href={ basePath + "/" + productPriceHistory.id }>
          Edit
        </Link>
      </Button>
    </li>
    ...
    <div className="text-center">
      ...
      <div className="mt-6">
        <Button onClick={() => openModal()}>
          <PlusIcon className="h-4" /> New Product Price History </Button>
      </div>
    </div>
  );
};
