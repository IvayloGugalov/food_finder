...
export default function SupermarketList({
  ...
  const { optimisticSupermarkets, addOptimisticSupermarket } = useOptimisticSupermarkets(
    supermarkets,
  ...
  return (
    ...
    >
      ...
      <Button variant={"link"} asChild>
        <Link href={ basePath + "/" + supermarket.id }>
          Edit
        </Link>
      </Button>
    </li>
    ...
    <div className="text-center">
      ...
      <div className="mt-6">
        <Button onClick={() => openModal()}>
          <PlusIcon className="h-4" /> New Supermarkets </Button>
      </div>
    </div>
  );
};
