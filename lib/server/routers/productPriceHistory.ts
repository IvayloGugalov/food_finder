import { getProductPriceHistoryById, getProductPriceHistories } from "@/lib/api/productPriceHistory/queries";
...
import { createProductPriceHistory, deleteProductPriceHistory, updateProductPriceHistory } from "@/lib/api/productPriceHistory/mutations";
...
export const productPriceHistoryRouter = router({
  ...
  getProductPriceHistoryById: publicProcedure.input(productPriceHistoryIdSchema).query(async ({ input }) => {
