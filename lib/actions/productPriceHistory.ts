...
export const createProductPriceHistoryAction = async (input: NewProductPriceHistoryParams) => {
  try {
...
export const updateProductPriceHistoryAction = async (input: UpdateProductPriceHistoryParams) => {
  try {
