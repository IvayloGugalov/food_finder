...
import { getShoppingLists } from "@/lib/api/shoppingLists/queries";import OptimisticShoppingProduct from "@/app/(app)/shopping-products/[shoppingProductId]/OptimisticShoppingProduct";
  ...
  return (
    <Suspense fallback={<Loading />}>
      <div className="relative">
        ...
        <OptimisticShoppingProduct shoppingProduct={shoppingProduct} products={products}
        productId={shoppingProduct.productId} shoppingLists={shoppingLists}
