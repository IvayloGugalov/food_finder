                ...
                <div className='mt-2'>
                  ...
                  <ol className='text-sm text-gray-500 list-disc ml-8 mt-2 flex gap-2 flex-col'>
                    <li className='list-item list-disc'>
                      Create an Edge Config and connect it to this project and store its
                      connection string under the{' '}
                    ...
                    <li className='list-item list-disc'>
                      Pull your latest Environment Variables if you are developing
                      locally
                    </li>
                    <li className='list-item list-disc'>
                  ...
                  <p className='text-sm text-gray-500 mt-2'>
                    Then reload the page and this dialog will go away if your setup is
                    correct.
                  </p>
                </div>
              </div>
