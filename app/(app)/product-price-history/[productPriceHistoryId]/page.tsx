...
import { getProducts } from "@/lib/api/products/queries";import OptimisticProductPriceHistory from "./OptimisticProductPriceHistory";
  ...
  return (
    <Suspense fallback={<Loading />}>
      <div className="relative">
        ...
        <OptimisticProductPriceHistory productPriceHistory={productPriceHistory} products={products} />
      </div>
    </Suspense>
  );
};
