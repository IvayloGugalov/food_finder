...
export default function OptimisticProductPriceHistory({ 
  ...
  const [optimisticProductPriceHistory, setOptimisticProductPriceHistory] = useOptimistic(productPriceHistory);
  ...
  return (
    <div className="m-4">
      ...
      <div className="flex justify-between items-end mb-4">
        <h1 className="font-semibold text-2xl">{optimisticProductPriceHistory.productId}</h1>
